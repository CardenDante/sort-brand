          ...
          <div className="container mx-auto px-6 py-10 md:py-16">
            ...
            <div className="hidden md:grid grid-cols-12 gap-8">
              ...
              <div className="col-span-2">
                <h3 className="text-[#D4AF34] text-lg font-bold mb-6">
                  Quick Links
                </h3>
                <ul className="space-y-3 text-white/80">
                  {["Careers", "Academy", "FAQs", "Client Portfolio"].map(
                    (link) => (
                      <li key={link}>
                        <Link
                          href={`/${link.toLowerCase().replace(/\s/g, "-")}`}
                          className="hover:text-[#D4AF34]"
                        >
                          {link}
                        </Link>
                      </li>
              ...
              <div className="col-span-2">
                ...
                <ul className="space-y-3 text-white/80">
                  <li>
                    <Link href="/privacy-policy" className="hover:text-[#D4AF34]">
                      Privacy Policy
                    </Link>
                  </li>
                  <li>
                    <Link href="/terms-of-use" className="hover:text-[#D4AF34]">
                      Terms of Use
                    </Link>
                  </li>
                  <li>
                    <Link href="/news" className="hover:text-[#D4AF34]">
                      News & Insights
                    </Link>
                  </li>
                </ul>
