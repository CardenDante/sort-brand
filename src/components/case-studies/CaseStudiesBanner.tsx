// src/components/CaseStudiesBanner.tsx
...
const CaseStudiesBanner = ({
  title,
  subtitle,
  backgroundImage = "/images/case-studies/case-studies-banner.jpg",
}: CaseStudiesBannerProps) => {
  return (
          ...
          <nav className="py-4">
            <ol className="flex items-center flex-wrap">
              ...
              <li className="flex items-center">
                ...
                <span className="text-[#D4AF34] font-medium">Case Studies</span>
              </li>
            </ol>
          </nav>
        </div>
